(() => {
    ...
    const elements = {
        ...
        cartCount: document.querySelector(".cs-cart-count"),
    };
    ...
    const eventManager = {
        ...
        handleShopNowClick(event) {
            const shopLink = event.target.closest("#services-448 .cs-link");
            if (!shopLink) return;
    ...
    const init = {
        ...
        eventListeners() {
            document.addEventListener("click", eventManager.handleShopNowClick);
